...
function measureTightDepth(proj, currentBoxD){
  ...
  for(const k of sideKeys){
    ...
    refH = p.h; // identical for every side panel (= boxD * PX_PER_MM, PX_PER_MM now scales with Shadow Scale)
...
// sliderMap / labelIdMap live in ui.js (used by initUI()) — not duplicated here.
